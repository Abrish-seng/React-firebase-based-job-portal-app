...
function SearchBar(props) {
  ...
  return (
    <div className='flex search gap-4 my-10 justify-center px-10 mb-20'>
       ...
       <select onChange={handleChange} name="location" value={jobCriteria.location} className=' py-3 pl-4 bg-zinc-200 font-semibold rounded-md'>
        ...
        <select onChange={handleChange} name="exprience" value={jobCriteria.exprience} className=' py-3 pl-4 bg-zinc-200 font-semibold rounded-md'>
